...
public class IndexService {
    ...
    /**
     * @param offset commitLog内最早的消息的 phyOffset
     */
    ...
    /**
     * 上层 DefaultMessageStore 内部启动的 异步线程 会 将commitlog 内的新msg 给包装成 dispatchRequest
     * 最终 交给 当前方法
     * @param req  类似 msg，只不过没有body字段
     */
    public void buildIndex(DispatchRequest req) {
        // 获取当前 索引文件，如果List内不存在 file 或者 当前 file 写满 的话，则创建 新的 file
