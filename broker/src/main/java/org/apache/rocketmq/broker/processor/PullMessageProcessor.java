...
public class PullMessageProcessor extends AsyncNettyRequestProcessor implements NettyRequestProcessor {
    ...
    private RemotingCommand processRequest(final Channel channel, RemotingCommand request, boolean brokerAllowSuspend)
        ...
        // 参数6：messageFilter 上一步创建的消息过滤器（服务器这里，一般都是tagCode过滤..）
        ...
        if (getMessageResult != null) {
            ...
            // 设置responseHeader.nextBeginOffset 为 服务器计算出来的 该队列 下一次pull时使用的offset
            ...
            // 根据getMessageResult的状态 设置 response的code ，参考为给大家画的图，不要去看这块代码了..
            ...
            switch (response.getCode()) {
                case ResponseCode.SUCCESS:// 查询成功
                    ...
                    break;
                case ResponseCode.PULL_NOT_FOUND:
                    // 大部分情况下都是 pullRequest.offset  ==  queue.maxOffset
    ...
    private byte[] readGetMessageResult(final GetMessageResult getMessageResult, final String group, final String topic,
        final int queueId) {
        // 根据 bufferTotalSize 创建 大的 byteBuffer 对象
        ...
        try {
            ...
            for (ByteBuffer bb : messageBufferList) {
                // 将每一条msg byteBuffer 存入到 大的 byteBuffer 对象内
                byteBuffer.put(bb);
